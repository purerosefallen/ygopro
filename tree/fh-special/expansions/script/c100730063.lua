...
function c100730063.initial_effect(c)
	aux.SpeedDuelReplaceDraw(c,c100730063.skill,c100730063.con,aux.Stringid(100730063,0))
...
function c100730063.con(e,tp)
	...
	return Duel.IsExistingMatchingCard(c100730063.filter,tp,LOCATION_MZONE,0,1,nil)
