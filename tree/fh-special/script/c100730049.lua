...
function c100730049.initial_effect(c)
	...
	aux.SpeedDuelBeforeDraw(c,c100730049.skill2)
	local e1=Effect.CreateEffect(c)
	e1:SetTarget(c100730049.Dfilter)
	e1:SetTargetRange(LOCATION_MZONE,0)
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_GRANT)
	e1:SetCode(EFFECT_INDESTRUCTABLE_COUNT)
	e1:SetCountLimit(1)
	e1:SetValue(c100730049.valcon)
...
function c100730049.valcon(e,re,r,rp)
	return bit.band(r,REASON_BATTLE)~=0
end

function c100730049.Dfilter(e,c)
