...
function c100730090.skill(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SelectYesNo(tp,aux.Stringid(100730090,0)) then
		...
		local g=Duel.GetMatchingGroup(Card.IsType,tp,LOCATION_DECK,0,nil,RACE_SPELLCASTER)
...
function c100730090.con(e,tp,eg,ep,ev,re,r,rp)
	...
	return Duel.GetTurnPlayer()==tp
		and Duel.GetMatchingGroupCount(Card.IsType,tp,LOCATION_DECK,0,nil,RACE_SPELLCASTER)>0
