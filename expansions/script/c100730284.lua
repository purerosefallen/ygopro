...
function c100730284.initial_effect(c)
	...
	e1:SetOperation(c100730284.skill2)
	e1:SetLabelObject(c)
...
function c100730284.skill(e,tp,c)
	tp=e:GetLabelObject():GetOwner()
...
function c100730284.skill2(e,tp,eg,ep,ev,re,r,rp)
	tp = e:GetLabelObject():GetOwner()
	local g=Group.CreateGroup()
	local c=Duel.CreateToken(tp,80244114)
	g:AddCard(c)
	aux.CardAddedBySkill:AddCard(c)
	c=Duel.CreateToken(tp,63184227)
	g:AddCard(c)
	aux.CardAddedBySkill:AddCard(c)
