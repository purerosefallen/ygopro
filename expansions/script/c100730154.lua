...
function c100730154.con(e,tp)
	...
	return aux.SpeedDuelAtMainPhaseCondition(e,tp)
		and Duel.IsExistingMatchingCard(c100730154.filter,tp,LOCATION_MZONE,0,1,nil) 
end
function c100730154.skill(e,tp,eg,ep,ev,re,r,rp)
	tp=e:GetLabelObject():GetOwner()
	Duel.Hint(HINT_CARD,1-tp,100730154)
	local g=Duel.SelectMatchingCard(tp,c100730154.filter,tp,LOCATION_MZONE,0,1,3,nil)
	local tc=g:GetFirst()
	while tc do
