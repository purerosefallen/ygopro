...
function aux.DisableBigDamageValue(e,re,val,r,rp,rc)
	if r&REASON_EFFECT==REASON_EFFECT and val>=2000 then return 2000 end
	return val
end
...
function aux.CannotActivate(tp)
	if not aux.SP4 then
		...
		aux.SP3={18027138,40975243,18322364,33298291,34707034,49808196,50750868,56051648,65664792,

7949763,72537897,73199638,93224848,96383838,97433739}
