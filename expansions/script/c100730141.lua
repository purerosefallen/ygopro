...
function c100730141.con(e,tp)
	...
	return aux.SpeedDuelAtMainPhaseCondition(e,tp)
		...
		and Duel.IsExistingMatchingCard(c100730141.filter,tp,LOCATION_MZONE,0,1,nil)
end
function c100730141.skill(e,tp)
	...
	local to=Duel.SelectMatchingCard(tp,c100730141.filter,tp,LOCATION_MZONE,0,1,1,nil):GetFirst()
