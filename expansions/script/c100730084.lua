...
function c100730084.skill(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SelectYesNo(tp,aux.Stringid(100730084,0)) then
		...
		local g=Duel.GetMatchingGroup(Card.IsType,tp,LOCATION_DECK,0,nil,ATTRIBUTE_WATER)
...
function c100730084.con(e,tp,eg,ep,ev,re,r,rp)
	...
	return Duel.GetTurnPlayer()==tp
		and Duel.GetMatchingGroupCount(Card.IsType,tp,LOCATION_DECK,0,nil,ATTRIBUTE_WATER)>0
