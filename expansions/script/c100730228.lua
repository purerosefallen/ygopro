...
function c100730228.initial_effect(c)
	aux.SpeedDuelAtMainPhase(c,c100730228.skill,c100730228.con,aux.Stringid(100730228,0))
	aux.RegisterSpeedDuelSkillCardCommon()
end
function c100730228.Isshark(c)
	return c:IsCode(5014629) or c:IsCode(74416224) and c:IsFaceup()
end

function c100730228.con(e,tp)
	tp=e:GetLabelObject():GetOwner()
	return aux.SpeedDuelAtMainPhaseCondition(e,tp)
		and Duel.IsExistingMatchingCard(c100730228.Isshark,tp,LOCATION_MZONE,0,1,nil)
		and Duel.IsPlayerCanSpecialSummon(tp)
end
function c100730228.skill(e,tp,eg,ep,ev,re,r,rp)
	tp=e:GetLabelObject():GetOwner()
	Duel.Hint(HINT_CARD,1-tp,100730228)
	local g1=Duel.SelectMatchingCard(tp,c100730228.Isshark,tp,LOCATION_MZONE,0,1,1,nil)
