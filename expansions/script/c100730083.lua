...
function c100730083.skill(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SelectYesNo(tp,aux.Stringid(100730083,0)) then
		...
		local g=Duel.GetMatchingGroup(Card.IsType,tp,LOCATION_DECK,0,nil,ATTRIBUTE_FIRE)
...
function c100730083.con(e,tp,eg,ep,ev,re,r,rp)
	...
	return Duel.GetTurnPlayer()==tp
		and Duel.GetMatchingGroupCount(Card.IsType,tp,LOCATION_DECK,0,nil,ATTRIBUTE_FIRE)>0
