...
function c100730048.con(e,tp)
	...
	return aux.SpeedDuelAtMainPhaseCondition(e,tp)
		...
		and Duel.IsExistingMatchingCard(c100730038.filter,tp,LOCATION_GRAVE,0,1,nil)
end

function c100730048.skill(e,tp)
	tp=e:GetLabelObject():GetOwner()
	local g1=Duel.GetMatchingGroup(c100730038.filter,tp,LOCATION_GRAVE,0,nil)
