...
function c100730171.initial_effect(c)
	aux.SpeedDuelAtMainPhase(c,c100730171.skill,c100730171.con,aux.Stringid(100730171,0))
	aux.RegisterSpeedDuelSkillCardCommon()
end

function c100730171.Ismask(c)
...
function c100730171.con(e,tp)
	...
	return aux.SpeedDuelAtMainPhaseCondition(e,tp)
		and Duel.IsExistingMatchingCard(c100730171.Ismask,tp,LOCATION_MZONE+LOCATION_SZONE,0,1,nil)
		and Duel.GetLocationCount(tp,LOCATION_SZONE)>0
end
function c100730171.skill(e,tp)
