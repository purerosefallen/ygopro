...
function c100730229.initial_effect(c)
	aux.SpeedDuelBeforeDraw(c,c100730229.skill)
	aux.RegisterSpeedDuelSkillCardCommon()
end
function c100730229.filter(c,g)
...
function c100730229.skill(e,tp)
	tp=e:GetLabelObject():GetOwner()
	local g=Group.CreateGroup()
	if not Duel.IsExistingMatchingCard(c100730229.filter,tp,LOCATION_DECK+LOCATION_HAND,0,7,nil,g) then
		Duel.Hint(HINT_MESSAGE,tp,aux.Stringid(100730229,0))
		e:Reset()
		return
	end
	tp=e:GetLabelObject():GetOwner()
