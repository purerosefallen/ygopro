...
function c210000000.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(aux.NecroValleyFilter(c210000000.thfilter),tp,LOCATION_GRAVE+LOCATION_DECK,0,1,nil) end
...
function c210000000.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) then
		...
		local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c210000000.thfilter),tp,LOCATION_GRAVE+LOCATION_DECK,0,1,1,nil)
