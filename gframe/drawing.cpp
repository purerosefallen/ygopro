...
void Game::DrawMisc() {
	...
	if(!dInfo.isReplay && dInfo.player_type < 7 && dInfo.time_limit) {
		...
		DrawShadowText(numFont, dInfo.str_time_left[1], Resize(813, 31, 848, 50), Resize(0, 1, 2, 0), dInfo.time_color[1], 0xff000000, true, false, 0);

		driver->draw2DImage(imageManager.tCover[0], ResizeCardMid(443, 32, 455, 50, 455, 41), ResizeFit(0, 0, 12, 18), 0, 0, true);
		driver->draw2DImage(imageManager.tCover[1], ResizeCardMid(850, 32, 862, 50, 862, 41), ResizeFit(0, 0, 12, 18), 0, 0, true);

		DrawShadowText(numFont, dInfo.str_card_count[0], Resize(455, 31, 470, 50), Resize(0, 1, 2, 0), dInfo.card_count_color[0], 0xff000000, true, false, 0);
		...
		driver->draw2DImage(imageManager.tCover[0], ResizeCardMid(588, 32, 600, 50, 600, 41), ResizeFit(0, 0, 12, 18), 0, 0, true);
		driver->draw2DImage(imageManager.tCover[1], ResizeCardMid(695, 32, 707, 50, 707, 41), ResizeFit(0, 0, 12, 18), 0, 0, true);
