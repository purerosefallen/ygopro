...
void TagDuel::RequestField(DuelPlayer* dp) {
	...
	RefreshMzone(1 - player, 0xef9fff, 0, dp);
	RefreshMzone(player, 0xef9fff, 0, dp);
	RefreshSzone(1 - player, 0xef9fff, 0, dp);
	RefreshSzone(player, 0xef9fff, 0, dp);
	RefreshHand(1 - player, 0xef9fff, 0, dp);
	RefreshHand(player, 0xef9fff, 0, dp);
	RefreshGrave(1 - player, 0xef9fff, 0, dp);
	RefreshGrave(player, 0xef9fff, 0, dp);
	RefreshExtra(1 - player, 0xef9fff, 0, dp);
	RefreshExtra(player, 0xef9fff, 0, dp);
	RefreshRemoved(1 - player, 0xef9fff, 0, dp);
	RefreshRemoved(player, 0xef9fff, 0, dp);
	/*
