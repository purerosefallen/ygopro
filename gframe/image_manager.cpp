...
/** Load card picture from configured search paths.
 ...
 * If targetWidth / targetHeight are provided for JPEG files, libjpeg DCT-domain scaling is used for faster decoding.
...
irr::video::IImage* ImageManager::GetImage(int code, irr::s32 targetWidth, irr::s32 targetHeight) {
	return LoadFromSearchPaths(code, "pics", {"png", "jpg"}, [this, targetWidth, targetHeight](const char* file) {
